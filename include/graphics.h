...
public:
  ...
  int DrawGlyph(Canvas *c, int x, int y,
                ...
                uint32_t unicode_codepoint, int width_offset = 0) const;
...
int DrawText(Canvas *c, const Font &font, int x, int y,
             const Color &color, const Color *background_color,
             const char *utf8_text, int kerning_offset = 0, int width_offset = 0, int width = 64, int initial_offset = 1, bool center = false);

// Same without background. Deprecated, use the one above instead.
int DrawText(Canvas *c, const Font &font, int x, int y, const Color &color,
             const char *utf8_text, int width_offset = 0, int width = 64, int initial_offset = 1, bool center = false);
